import { ArrowLeft, BookOpen, BriefcaseBusiness, CalendarDays } from "lucide-react";
      ...
      <div id="main" className="mx-auto max-w-[1180px] px-5 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[14px] text-[#5b6b64]">Webinars, workshops, hackathons, and networking</p>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-[22px] border border-white bg-white p-10 text-center shadow-[0_18px_40px_-28px_rgba(18,50,36,0.18)]">
          ...
          <h2 className="mt-5 font-[family-name:var(--font-display)] text-[22px] font-semibold text-[#12241c]">
            Event listings are not live yet
          </h2>
          <p className="mx-auto mt-3 max-w-md text-[14px] leading-6 text-[#5b6b64]">
            CareerOS does not have an events API or published catalog. Save, register, and seat counts would be fake, so this page stays empty until those endpoints exist.
          </p>
